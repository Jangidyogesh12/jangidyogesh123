...
const What_I_do=()=>{
    return(
        ...
        <div className="flex flex-row items-center pb-16">            
            <h1 className=" text-5xl text-black translate-x-[8vw] relative">What I Do :</h1> 
            <p className=" w-1/2 text-black translate-x-[20vw] text-lg text-justify">{What_I_doText}</p>
        </div>
