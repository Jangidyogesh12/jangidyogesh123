...
const Card:React.FC<CardProps>=({title, imageURL, description, Link})=>{
    ...
    <>
    <a href={Link}>
        <div className="flex-row items-center relative border-2 border-solid border-[#ffffff49] hover:border-[#ffffffbb] rounded-lg h-[25vh] sm:h-[30vh] md:h-[40vh] w-[80vw] md:w-[30vw] overflow-hidden group cursor-pointer hover:scale-105 transition-transform ease-in-out duration-150">
